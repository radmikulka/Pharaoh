...
namespace Pharaoh
{
    ...
    public class CProjectInstaller : CBaseDiInstaller
    {
        ...
        [SerializeField] private CHitsDispatcher _hitsDispatcher;
        ...
        private void InstallServerClient()
        {
            ...
            Container.AddSingletonFromInstance<CHitsDispatcher>(_hitsDispatcher);
        }
