...
{
	[CreateAssetMenu(menuName = "____TycoonBuilder/Configs/TransportTypeConfig", fileName = "cfg_transportType_")]
	public class CTransportTypeConfig : CScriptableResourceConfig<ETransportType>, IIHaveBundleLinks
	{
