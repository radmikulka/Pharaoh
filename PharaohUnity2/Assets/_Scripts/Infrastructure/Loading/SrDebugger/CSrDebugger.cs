...
namespace TycoonBuilder
{
	public class CSrDebugger
	{
		...
		private class COptions
		{
			...
			{
				get => CServerConfig.Instance.FakeDelayInSecs;
				set => CServerConfig.Instance.FakeDelayInSecs = value;
			}
			...
			[Category(DebugCategory)]
			public void ForceInternalHitError()
			{
				Object.FindFirstObjectByType<CBaseEditorCommands>().ForceInternalHitError();
			}
