Shader "Custom/Unlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Includes
            #include "Assets/_Shaders/Unlit/UnlitInput.hlsl"
            #include "Assets/_Shaders/Unlit/UnlitForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.CUnlitShader"
}
